...
:width: 60%
:align: left
:alt: Afbeelding van ShowthePhysics 
...
:width: 50%
:align: left
:alt: Geluid opgenomen met de phyphox app.
...
## {math}`v_{geluid} = f λ` maar snelheid is onafhankelijk van frequentie en golflengte!
...
[^dfsds]: [https://​interactivetextbooks​.tudelft​.nl​/showthephysics​/demos​/demo79​/demo79​.html](https://interactivetextbooks.tudelft.nl/showthephysics/demos/demo79/demo79.html)